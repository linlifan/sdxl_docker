#ENV_PATH=/data/conda/env/sd_demo
#
...
numactl --localalloc --physcpubind=48-95 python sd_pipe_sdxl_turbo.py --height 512 --width 512  --repeat 11 --step 4 --bf16 --prompt "$PROMPT"
numactl --localalloc --physcpubind=48-95 python sd_pipe_sdxl_turbo.py --height 1024 --width 1024  --repeat 11 --step 4 --bf16 --prompt "$PROMPT"
