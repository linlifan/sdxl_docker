...
class StableDiffusionXLPipelineIpex(
    ...
    def prepare_for_ipex(
        ...
        **kwargs,
        ...
        unet_input_example = {"sample": latent_model_input, "timestep": dummy, "encoder_hidden_states" : prompt_embeds, "added_cond_kwargs": added_cond_kwargs}
        
        #unet_input_example = (latent_model_input, dummy, prompt_embeds)
        
        print("type: ",type(latent_model_input), type(dummy), type(prompt_embeds))
